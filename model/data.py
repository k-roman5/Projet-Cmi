...
def extract_df1(stations):
    ...
    for station in stations:
        query = "SELECT station.nom, recolte.Ntot, recolte.Mtot, recolte.Year,arbre.VH, recolte.oneacorn FROM station JOIN arbre ON id_s=s_id JOIN recolte ON id_a=a_id  WHERE nom='{}'".format(
            station)
